...
export const Icons = {
  ...
  ShoppingCart: ({ className = "w-5 h-5" }: IconProps = {}) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  Package: ({ className = "w-5 h-5" }: IconProps = {}) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  Minus: ({ className = "w-5 h-5" }: IconProps = {}) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  // Dietary indicators
  Leaf: ({ className = "w-4 h-4" }: IconProps = {}) => (
  ...
  Badge: ({ className = "w-4 h-4" }: IconProps = {}) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
